...
class FavorisPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final secondaryColor = Theme.of(context).secondaryHeaderColor; // Fetch secondary color from theme
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: 2, // Two containers per line
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: borderColor, width: 2.0), // Use the secondary color for border
                  ),
                ),
                Positioned(
                  top: 5,
